...
const scrollContent = [
  {
    ...
    title: "Pesquisa",
    titleAccent: "Quantitativa",
    subtitle: "Dados precisos para insights profundos",
    description: "Nossa metodologia utiliza questionários cientificamente validados e análises estatísticas avançadas para mapear competências socioemocionais, coletando dados de amostras representativas que permitem conclusões significativas sobre o desenvolvimento estudantil.",
    accent: "from-blue-500 to-indigo-600",
    bgAccent: "from-blue-50/80 to-indigo-50/60",
    textAccent: "text-blue-600",
    icon: "📊",
    metrics: ["95% confiabilidade", "Validação científica", "Amostra representativa"],
  },
  {
    id: 2,
    ...
    subtitle: "IA avançada para padrões complexos",
    description: "Nossos algoritmos de inteligência artificial identificam padrões sutis e correlações invisíveis ao olho humano, transformando dados brutos em insights acionáveis que revelam o perfil socioemocional único de cada estudante e suas necessidades de desenvolvimento.",
    accent: "from-emerald-500 to-teal-600",
    bgAccent: "from-emerald-50/80 to-teal-50/60",
    textAccent: "text-emerald-600",
    icon: "🧠",
    metrics: ["IA proprietária", "Padrões complexos", "Insights únicos"],
  },
  {
    id: 3,
    ...
    description: "Criamos relatórios visuais intuitivos e dashboards interativos que traduzem análises complexas em recomendações claras e acionáveis, fornecendo às escolas uma base sólida para estratégias pedagógicas personalizadas e eficazes.",
    accent: "from-purple-500 to-violet-600",
    bgAccent: "from-purple-50/80 to-violet-50/60",
    textAccent: "text-purple-600",
    icon: "📈",
    metrics: ["Dashboards interativos", "Recomendações claras", "Estratégias personalizadas"],
  },
];
      ...
      <Background>
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center px-8 pt-32 pb-20">
          ...
          <div className={`flex justify-center mb-14 transform transition-all duration-1000 ${
            ...
            <div className="relative inline-flex items-center gap-4 bg-purple-50/40 backdrop-blur-xl border border-purple-200/40 rounded-full px-7 py-3.5 shadow-lg shadow-purple-100/30">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-2.5 h-2.5 bg-gradient-to-r from-purple-400 to-purple-500 rounded-full animate-pulse"></div>
                  <div className="absolute inset-0 w-2.5 h-2.5 bg-purple-400 rounded-full animate-ping opacity-20"></div>
                </div>
          ...
          <div className={`text-center space-y-12 max-w-6xl mx-auto transform transition-all duration-1000 delay-300 ${
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight">
              <span className="text-slate-700">Mapeamos competências </span>
              <br />
              <span className="text-slate-700">socioemocionais para </span>
            ...
            <p className="max-w-4xl mx-auto text-xl md:text-2xl text-slate-600 leading-relaxed font-light">
              Nossa plataforma utiliza <span className="font-semibold text-slate-700">ciência comportamental avançada</span> 
              para identificar, analisar e desenvolver as habilidades socioemocionais essenciais 
              para o sucesso dos estudantes no século XXI.
            </p>
          </div>
          ...
          <div className={`flex flex-col items-center mt-16 space-y-8 transform transition-all duration-1000 delay-600 ${
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center">
              <button className="group relative px-12 py-5 bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white font-bold text-lg rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-purple-200/40 hover:scale-105 overflow-hidden">
              ...
              <button className="px-8 py-5 bg-white/70 backdrop-blur-sm border-2 border-slate-200/60 hover:border-purple-300/60 text-slate-700 font-semibold text-lg rounded-2xl transition-all duration-300 hover:shadow-lg hover:bg-white/80">
          ...
          <div className={`flex justify-center mt-24 transform transition-all duration-1000 delay-900 ${
            ...
            <div className="flex flex-col items-center gap-3 cursor-pointer">
              ...
              <div className="relative w-8 h-14 rounded-full border-2 border-purple-400/80 overflow-hidden flex justify-center items-start">
                <span className="absolute top-4 w-2 h-5 bg-gradient-to-b from-purple-400 to-purple-600 rounded-full animate-bounce" />
              </div>
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div className={`absolute inset-0 transition-all duration-1000 ease-out bg-gradient-to-br ${scrollContent[currentSection]?.bgAccent || 'from-purple-50/80 to-violet-50/60'}`}></div>
          ...
          <div className="absolute top-8 left-1/2 -translate-x-1/2 z-30">
            <div className="flex items-center gap-4 bg-white/80 backdrop-blur-xl border border-white/40 rounded-2xl px-6 py-3 shadow-lg">
              ...
              <div className="text-sm font-semibold text-slate-700">
                Etapa {currentSection + 1} de {scrollContent.length}
              </div>
              <div className="w-px h-6 bg-slate-200"></div>
                    ...
                    <div className="max-w-2xl w-full space-y-8">
                      ...
                      <div className="pt-4">
                        <button className={`group relative px-8 py-4 bg-gradient-to-r ${item.accent} text-white font-semibold rounded-2xl transition-all duration-300 hover:shadow-xl hover:scale-105 overflow-hidden`}>
                          <span className="relative z-10 flex items-center gap-3">
                            Ver {item.titleAccent} em Detalhes
          ...
          <div className="absolute bottom-0 left-0 w-full h-1 bg-slate-100">
            <div
              className={`h-full bg-gradient-to-r ${scrollContent[currentSection]?.accent || 'from-purple-500 to-violet-600'} transition-all duration-300 ease-out`}
