...
import { ScrollTrigger as GSAPScrollTrigger } from "gsap/dist/ScrollTrigger";
...
export default function ScrollTrigger() {
  ...
  useEffect(() => {
    ...
    // Inicia o estado dos elementos da direita (exceto o primeiro)
    ...
    images.forEach((img, i) => {
      if (images[i + 1]) {
        tl.to(img, { opacity: 0 })
          ...
          .to(rightElements[i + 1], { yPercent: 0, ease: "none" }, "<");
      }
    });
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className="w-1/2 h-screen overflow-hidden relative flex justify-center items-center">
          <div className="w-full max-w-[400px] h-full max-h-[400px] relative overflow-hidden">
            <img
        ...
        <div className="w-1/2 h-screen overflow-hidden relative">
          <div className="w-full">
            <div
              ...
              className="w-full h-screen flex justify-center items-center text-[100px] text-black"
            >
              casfhdjfhsifhsdiofhosifhdiosfhsdiofhsoifdhsl\ç
            </div>
            <div
